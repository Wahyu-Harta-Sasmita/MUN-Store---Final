              ...
              <div class="mt-auto p-4 flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                  <div class="flex flex-col bg-white rounded-lg px-9 py-2">
                    ...
                    <input type="number" name="pay" id="pay" class="border border-green-300 rounded-md px-3 py-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500">
                  </div>
